							...
							<div class="col-md-3">
								<div class="product-item">
									<figure class="product-style">
										<img src="{{Storage::url($featured->image)}}" alt="Books" class="product-item">
									...
									<figcaption>
										...
										<div class="item-price"> &#36; {{ $featured->price }}.00 </div>
									</figcaption>
								</div>
							</div>
							@empty
							<p class="align-center">Belum ada buku terkait kategori berikut</p>
							@endforelse
						</div><!--ft-books-slider-->
					</div><!--grid-->
				</div><!--inner-content-->
				...
				<div class="inner-content">
					<div class="product-list" data-aos="fade-up">
						<div class="grid product-grid">
							...
							<div class="product-item">
								<figure class="product-style">
									<img src="{{Storage::url($offer->image)}}" alt="Books" class="product-item">
									<button type="button" class="add-to-cart" data-product-tile="add-to-cart">Add to
										Cart</button>
								</figure>
								<figcaption>
									<h3>{{ $offer->title }}</h3>
									<span>{{ $offer->writer }}</span>
									<div class="item-price">
										<span class="prev-price">$ 50.00</span>&#36; {{ $offer->price }}.00
									</div>
								</figcaption>
							</div>
							@empty
